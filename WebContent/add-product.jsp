<%-- 
    ...
    Created on : Jun 15, 2016, 6:07:08 PM
    Author     : BINH
--%>
...
<%
    if (request.getSession().getAttribute("account") == null){
        request.getRequestDispatcher("FilterLogin").forward(request, response);
    }
%>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="row">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a href="cart.html">Add Product</a></li>
            ...
            <div class="row" style="height: 339px">
                ...
                <div class="col-md-6 col-md-offset-3">
                    <form role="form" method="post" action="">
                        ...
                        <div class="form-group">
                            <label for="password">Giá </label><input type="number" size="4"
                                                                     class="input-text qty text form-control" title="Qty" value="1"
                                                                     min="0" step="1">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="txtDescription" id=""txtDescription"" rows="10" cols="80">
                    ...
                    <div class="form-group">
                        <label for="image">Hình ảnh</label> <input type="text" name="txtImage"
                                                                   class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="role">Danh mục sản phẩm</label> <select class="form-control"
                                                                            id="role" name="role">
