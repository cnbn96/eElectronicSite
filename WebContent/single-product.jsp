<%-- 
    ...
    Created on : Jun 17, 2016, 12:30:30 AM
    Author     : BINH
--%>
                ...
                <div class="col-md-12">
                    <div class="product-content-right">
                        <div class="product-breadcroumb">
                            <a href="/">Home</a>
                            <a href="">${product.productCategory.categoryName}</a>
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    ...
                                    <div class="product-inner-price">
                                        <ins>$${product.productPrice}</ins> <del>$${product.productPricePromotion}</del>
                                    </div>    
                                    
                                    <form action="AddToCartServlet" class="cart">
                                        <div class="quantity">
